...
//        System.out.println(endTime);
    ...
    public void AverageConnection() {
        ...
        System.out.println("Started:" + startedTime1);
        try {
            // create our mysql database connection
            String myDriver = "org.gjt.mm.mysql.Driver";
            String myUrl = "jdbc:mysql://localhost/databaseanalysis";
            ...
            // our SQL SELECT query. 
            // if you only need a few columns, specify them by name instead of using "*"
            String query = "SELECT ID, AVG(COL1), AVG(COL2), AVG(COL3), AVG(COL4), AVG(COL5) FROM databaseanalysis";
            ...
            while (rs.next()) {
                int id = rs.getInt("id");
                int col1 = rs.getInt("AVG(COL1)");
                int col2 = rs.getInt("AVG(COL2)");
                int col3 = rs.getInt("AVG(COL3)");
                int col4 = rs.getInt("AVG(COL4)");
                int col5 = rs.getInt("AVG(COL5)");
